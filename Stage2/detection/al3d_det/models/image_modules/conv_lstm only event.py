...
class GOF_LSTM(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        if 'gof_hidden_state' in batch_dict['event_features'].keys():
            hidden_state = self.lstm(data, batch_dict['event_features']['gof_hidden_state'])
        else:
            hidden_state = self.lstm(data)
        
        batch_dict['event_features']['gof_hidden_state'] = hidden_state
        # batch_dict['event_features']['gof_lstm_feat'] = hidden_state[0]
