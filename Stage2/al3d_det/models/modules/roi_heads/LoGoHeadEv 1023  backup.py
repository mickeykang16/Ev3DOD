...
class VoxelAggregationHead(RoIHeadTemplate):
    ...
    def forward(self, batch_dict, index):
        ...
        pooled_features = batch_dict['GoF_result_feats'].detach()
        ...
        localgrid_densityfeat.requires_grad_(True)
        ...
        pooled_features = localgrid_densityfeat_fuse.permute(0, 2, 1) + batch_dict['LoF_result_feats'].detach()
