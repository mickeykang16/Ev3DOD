...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict, index):
        ...
        batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_gt_ids = self.sample_rois_for_rcnn(
        ...
        targets_dict = {'rois': batch_rois, 'gt_of_rois': batch_gt_of_rois, 'gt_iou_of_rois': batch_roi_ious,
                        ...
                        'rcnn_cls_labels': batch_cls_labels, 'batch_gt_ids': batch_gt_ids}
    ...
    def sample_rois_for_rcnn(self, batch_dict, time_idx):
        ...
        batch_gt_id = rois.new_zeros(batch_size, self.roi_sampler_cfg.ROI_PER_IMAGE, dtype = torch.long)
        ...
        for index in range(batch_size):
            ...
            batch_gt_id[index] = cur_gt[gt_assignment[sampled_inds]][:, 9]
            
            # print("################## final batch_gt_of_rois ###############")
            # print(batch_gt_of_rois.shape)
            # print(batch_gt_of_rois)

        return batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_gt_id
